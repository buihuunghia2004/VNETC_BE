...
class Page {
    ...
    async getPages(page = 1, limit = 10) {
        try {
            ...
            throw new ApiErr(StatusCodes.INTERNAL_SERVER_ERROR, "Failed to fetch pages");
        }
    }
    ...
    async getBySlug(slug) {
        try {
            ...
            if (error instanceof ApiErr) throw error;
            throw new ApiErr(StatusCodes.INTERNAL_SERVER_ERROR, "Failed to fetch page");
        }
    }
    ...
    async updatePage(slug, data, account, file) {
        try {
            ...
            if (error instanceof ApiErr) throw error;
            throw new ApiErr(StatusCodes.INTERNAL_SERVER_ERROR, "Failed to update page");
        }
    }
}
